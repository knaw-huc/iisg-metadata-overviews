...
amount = 0 # if 0, than all records are handled (this is for testing purposes, for testing make it 10 or something else.
...
# os.mkdir(data_transformed_directory)
result_df.to_csv(f"{data_transformed_directory}/authority.gzip", sep = '\t', index = False, compression = 'gzip')
